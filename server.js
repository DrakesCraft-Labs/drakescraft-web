...
const storeCatalog = {
  ...
  products: [
    { id: 'hercules', category: 'monthly', tier: 1, name: 'Hércules', badge: 'Entrada VIP', clp: 4990, usd: 4.99, featured: false, accent: 'bronze', summary: 'El punto de partida VIP para entrar fuerte al survival sin perder el balance de la odisea.', includes: ['Suscripción mensual por 30 días y claim visual VIP Hércules', '2 regiones personales de 49x49, 3 homes y 5 warps de jugador (/pw)', 'Chat con colores, /hat y /clearinventory (/ci)', 'Kit celestial: diamante Protección IX, Irrompibilidad V y espada Sharpness XII + Looting V', 'Herramientas diamante Eficiencia X + Fortuna VI y utilidad completa de arranque', '48 zanahorias doradas, 64 filetes, 4 manzanas doradas, 8 ender pearls y 1 tótem', 'Efecto de set completo: Velocidad I + Resistencia I', '$35.000 ₯ al reclamar el kit'] },
    { id: 'hestia', category: 'monthly', tier: 2, name: 'Hestia', badge: 'Social', clp: 7990, usd: 7.99, featured: false, accent: 'rose', summary: 'Un salto claro hacia comodidad premium, mejor defensa y una economía inicial mucho más seria.', includes: ['Suscripción mensual por 30 días, hereda Hércules y suma claim visual VIP Hestia', '3 regiones personales de 81x81, 5 homes, /nick, /ptime, /pweather y /ext', 'Kit celestial: netherita Protección X, Irrompibilidad VI y espada Sharpness XIII + Looting VI', 'Pico Eficiencia XI + Fortuna VII, herramientas mejoradas y arco premium de soporte', '1 shulker, 6 gapples, 2 tótems y consumibles reforzados para progreso real', 'Efecto de set completo: Velocidad II + Health Boost I + Saturación', '$75.000 ₯ al reclamar el kit'] },
    { id: 'hermes', category: 'monthly', tier: 3, name: 'Hermes', badge: 'Recomendado', clp: 10990, usd: 10.99, featured: true, accent: 'violet', summary: 'Movilidad, exploración y calidad de vida. El rango recomendado para jugar survival intensivo a diario.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Hermes', '4 regiones de 113x113, /fly, /speed, /back, /workbench, /enderchest, /compass y /wild', 'Kit celestial: netherita Protección XI, Irrompibilidad VII y espada Sharpness XIV + Looting VII', 'Pico Eficiencia XII + Fortuna VIII, herramientas de viaje y combate escaladas', '1 shulker, 64 cohetes, 10 gapples, 3 tótems y mejor logística de exploración', 'Efecto de set completo: Velocidad IV + Health Boost I + Saturación', '$150.000 ₯ al reclamar el kit'] },
    { id: 'hefesto', category: 'monthly', tier: 4, name: 'Hefesto', badge: 'Técnico', clp: 15990, usd: 15.99, featured: false, accent: 'ember', summary: 'Pensado para granjas, minería seria y jugadores técnicos que quieren un survival pesado con herramientas reales.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Hefesto', '5 regiones de 177x177, 8 homes, /feed, /condense y estaciones virtuales completas', 'Kit celestial: netherita Protección XII, Irrompibilidad VIII y espada Sharpness XV + Looting VIII', 'Pico Eficiencia XIII + Fortuna IX y set completo de herramientas netherita avanzadas', '1 beacon, 1 shulker, 14 gapples, 1 notch apple y 4 tótems', 'Efecto de set completo: Velocidad II + Health Boost II + Resistencia al fuego + Saturación', '$250.000 ₯ al reclamar el kit'] },
    { id: 'artemisa', category: 'monthly', tier: 5, name: 'Artemisa', badge: 'Exploración', clp: 22990, usd: 22.99, featured: false, accent: 'cyan', summary: 'Verticalidad, daño a distancia y supervivencia de alto nivel para dominar mapas, océanos y combates largos.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Artemisa', '5 regiones de 241x241, 12 warps de jugador, /jump y conservación de XP al morir', 'Kit celestial: netherita Protección XIII, Irrompibilidad IX y espada Sharpness XVI + Looting IX', 'Arco de la Caza Divina: Power X, Punch III, Flame II, Infinity y Unbreaking X', '1 beacon, 1 shulker, 18 gapples, 2 notch apples y 6 tótems', 'Efecto de set completo: Velocidad III + Health Boost II + Fuerza I + Saturación', '$450.000 ₯ al reclamar el kit'] },
    { id: 'afrodita', category: 'monthly', tier: 6, name: 'Afrodita', badge: 'Economía', clp: 31990, usd: 31.99, featured: false, accent: 'pink', summary: 'El rango de comercio alto: acelera la economía, mantiene equipo fuerte y deja una presencia premium constante.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Afrodita', '6 regiones de 353x353, 12 homes, 15 warps, /repair, /sell y apertura de ChestShop sin fee', 'Kit celestial: netherita Protección XIV, Irrompibilidad X y espada Sharpness XVII + Looting X', 'Pico Eficiencia XV + Fortuna XI y herramientas netherita de línea alta', '2 beacons, 2 shulkers, 24 gapples, 3 notch apples y 8 tótems', 'Efecto de set completo: Velocidad III + Health Boost III + Fuerza I + Regeneración I + Saturación', '$700.000 ₯ al reclamar el kit'] },
    { id: 'zeus', category: 'monthly', tier: 7, name: 'Zeus', badge: 'Rango top', clp: 44990, usd: 44.99, featured: true, accent: 'gold', summary: 'La cima del Olimpo: utilidades máximas, kit definitivo y el set más fuerte que hoy existe en DrakesCraft.', includes: ['Suscripción mensual por 30 días y herencia total de la línea VIP anterior', '7 regiones de 481x481, 20 homes, 25 warps, /repair all, /heal, /near y keep inventory', 'Kit celestial: netherita Protección XV, Irrompibilidad XII y espada Sharpness XX + Looting XII', 'Pico Eficiencia XVIII + Fortuna XIII, equipo finalista y claim visual VIP Zeus', '3 beacons, 3 shulkers, 32 gapples, 8 notch apples y 12 tótems', 'Efecto de set completo: Velocidad IV + Health Boost IV + Fuerza II + Resistencia I + Saturación', '$1.500.000 ₯ al reclamar el kit'] },
