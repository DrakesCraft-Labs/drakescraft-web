...
const storeCatalog = {
  ...
  products: [
    { id: 'hercules', category: 'monthly', tier: 1, name: 'Hércules', badge: 'Entrada VIP', clp: 4990, usd: 4.99, featured: false, accent: 'bronze', summary: 'El punto de partida VIP para entrar fuerte al survival sin romper el balance del servidor.', includes: ['Suscripción mensual por 30 días, rango temporal y claim visual VIP Hércules', '3 regiones personales de 181x181, 3 homes y 5 warps de jugador (/pw)', 'Chat con colores, /hat y /clearinventory (/ci)', 'Kit celestial de arranque con diamante fuerte, herramientas mejoradas y consumibles premium', 'Aura de armadura Odysseia al usar set completo de diamante: Velocidad I + Resistencia I', 'Entrega automática del kit Hércules + visual PS y $35.000 ₯ en Dragmas'] },
    { id: 'hestia', category: 'monthly', tier: 2, name: 'Hestia', badge: 'Social', clp: 7990, usd: 7.99, featured: false, accent: 'rose', summary: 'Comodidad social, mejor defensa y una economía temprana bastante más sólida.', includes: ['Suscripción mensual por 30 días, hereda Hércules y suma claim visual VIP Hestia', '4 regiones personales de 301x301, 5 homes, /nick, /ptime, /pweather y /ext', 'Kit celestial mejorado con netherita temprana, arco de soporte y consumibles reforzados', 'Aura de armadura Odysseia al usar set completo de diamante: Velocidad II + Health Boost I + Saturación', 'Entrega automática del kit Hestia + visual PS y $75.000 ₯ en Dragmas'] },
    { id: 'hermes', category: 'monthly', tier: 3, name: 'Hermes', badge: 'Recomendado', clp: 10990, usd: 10.99, featured: true, accent: 'violet', summary: 'El rango recomendado para jugar survival intensivo con movilidad real y mucha calidad de vida.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Hermes', '5 regiones de 421x421, 6 homes, 8 warps, /fly, /speed, /back, /workbench, /enderchest, /compass y /wild', 'Kit celestial orientado a exploración, viaje y combate sostenido', 'Aura de armadura Odysseia al usar set completo de diamante: Velocidad IV + Health Boost I + Saturación', 'Entrega automática del kit Hermes + visual PS y $150.000 ₯ en Dragmas'] },
    { id: 'hefesto', category: 'monthly', tier: 4, name: 'Hefesto', badge: 'Técnico', clp: 15990, usd: 15.99, featured: false, accent: 'ember', summary: 'Pensado para granjas, minería pesada y jugadores técnicos que quieren herramientas reales.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Hefesto', '6 regiones de 177x177, 8 homes, 8 warps, /feed, /condense y estaciones virtuales completas', 'Kit celestial netherita con foco en minería, farmeo y supervivencia avanzada', 'Aura de armadura Odysseia al usar set completo de netherita: Velocidad II + Health Boost II + Resistencia al Fuego + Saturación', 'Entrega automática del kit Hefesto + visual PS y $250.000 ₯ en Dragmas'] },
    { id: 'artemisa', category: 'monthly', tier: 5, name: 'Artemisa', badge: 'Exploración', clp: 22990, usd: 22.99, featured: false, accent: 'cyan', summary: 'Verticalidad, daño a distancia y supervivencia de alto nivel para dominar mapas y combates largos.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Artemisa', '8 regiones de 901x901, 10 homes, 12 warps de jugador, /jump y conservación de XP al morir', 'Kit celestial con arco divino, netherita de línea alta y logística de exploración premium', 'Aura de armadura Odysseia al usar set completo de netherita: Velocidad III + Health Boost II + Fuerza I + Saturación', 'Entrega automática del kit Artemisa + visual PS y $450.000 ₯ en Dragmas'] },
    { id: 'afrodita', category: 'monthly', tier: 6, name: 'Afrodita', badge: 'Economía', clp: 31990, usd: 31.99, featured: false, accent: 'pink', summary: 'El rango de comercio alto: acelera la economía y mantiene una presencia premium constante.', includes: ['Suscripción mensual por 30 días, hereda anteriores y suma claim visual VIP Afrodita', '10 regiones de 1321x1321, 12 homes, 15 warps, /repair, /sell y apertura de ChestShop sin fee', 'Kit celestial netherita de línea alta con recursos premium para economía y PvE', 'Aura de armadura Odysseia al usar set completo de netherita: Velocidad III + Health Boost III + Fuerza I + Regeneración I + Saturación', 'Entrega automática del kit Afrodita + visual PS y $700.000 ₯ en Dragmas'] },
    { id: 'zeus', category: 'monthly', tier: 7, name: 'Zeus', badge: 'Rango top', clp: 44990, usd: 44.99, featured: true, accent: 'gold', summary: 'La cima del Olimpo: utilidades máximas, aura más fuerte y el kit más alto que hoy existe en DrakesCraft.', includes: ['Suscripción mensual por 30 días y herencia total de la línea VIP anterior', '15 regiones de 1801x1801, 20 homes, 25 warps, /repair all, /heal, /near y keep inventory', 'Kit celestial finalista con netherita top, herramientas extremas y claim visual VIP Zeus', 'Aura de armadura Odysseia al usar set completo de netherita: Velocidad IV + Health Boost IV + Fuerza II + Resistencia I + Saturación', 'Entrega automática del kit Zeus + visual PS y $1.500.000 ₯ en Dragmas'] },
